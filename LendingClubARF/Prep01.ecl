...
EXPORT Prep01 := MODULE
  ...
  CleanFilter := raw.loan_amnt <> 0 AND raw.fico_range_low <> 0 AND raw.pct_tl_nvr_dlq >=50  AND raw.installment <> 0 AND raw.fico_range_low >= 660 AND raw.annual_inc >= 10000 AND raw.all_util <> 0 AND raw.hardship_flag <> 'Y';
